...
@Service
public class TokenProvider { // 토큰 생성, 유효성 검사, 필요한 정보 반환
    ...
    private String makeToken(Date expiry, User user) {
        ...
        return Jwts.builder()
                ...
                .setExpiration(expiry) // 내용 exp : expiry(토근 만료시간) 멤버 변수값
                .setSubject(user.getEmail()) // 내용 sub(토큰제목) : 유저의 이메일
    ...
    public Long getUserId(String toke) {
